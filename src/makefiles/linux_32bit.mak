...
ifeq ($(STATIC),YES)
OPTIONS_LINK_RELEASE=-O2 -fsigned-char -lm -ldl -lrt -lpthread -lssl -lcrypto -lreadline -lncurses_g -lz
else
...
ifeq ($(DEBUG),YES)
	OPTIONS_COMPILE=$(OPTIONS_COMPILE_DEBUG) $(CFLAGS)
	OPTIONS_LINK=$(OPTIONS_LINK_DEBUG) $(LDFLAGS)
else
	OPTIONS_COMPILE=$(OPTIONS_COMPILE_RELEASE) $(CFLAGS)
	OPTIONS_LINK=$(OPTIONS_LINK_RELEASE) $(LDFLAGS)
endif
